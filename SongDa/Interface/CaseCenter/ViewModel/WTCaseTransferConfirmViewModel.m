//
//  WTCaseTransferConfirmViewModel.m
//  SongDa
//
...
@implementation WTCaseTransferConfirmViewModel

- (void)dataByParameters:(id)parameters success:(void (^)(id))success failure:(void (^)(NSError *, NSString *))failure {
    [[WTHTTPSessionManager sharedManager] HTTPRequestWithRelativePOSTPath:kCaseTransferConfirmPath parameters:parameters responeBlock:^(id jsonObject, NSError *error) {
