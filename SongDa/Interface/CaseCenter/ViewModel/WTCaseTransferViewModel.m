...
@implementation WTCaseTransferViewModel

- (void)dataByParameters:(id)parameters success:(void (^)(id))success failure:(void (^)(NSError *, NSString *))failure {
    [[WTHTTPSessionManager sharedManager] HTTPRequestWithRelativeGETPath:kCaseTransferPath parameters:parameters responeBlock:^(id jsonObject, NSError *error) {
