...
- (void)makeToastActivity:(id)position {
    ...
    UIView *activityView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, CSToastActivityWidth, CSToastActivityHeight+100)];
...
//    if (CSToastDisplayShadow) {
//        wrapperView.layer.shadowColor = [UIColor redColor].CGColor;
...
//    }
    ...
    wrapperView.frame = CGRectMake(0.0, 0.0, wrapperWidth, wrapperHeight+10);
    ...
    if(messageLabel != nil) {
        ...
        messageLabel.center = wrapperView.center;
